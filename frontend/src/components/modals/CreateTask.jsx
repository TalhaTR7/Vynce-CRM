                                ...
                                <div
                                    ...
                                    {assignee
                                        ? <>
                                            ...
                                            <img src={mood[assignee.currentMood ?? assignee.user?.currentMood]} className={styles.selectMood} alt="" />
                                        </>
                                        : <>
                                        ...
                                        {filteredMembers.map(m => {
                                            ...
                                            return (
                                                <li key={m._id} className={styles.dropdownOption} onClick={() => { setAssignee(u); setOpenDropdown(null); }}>
                                                    ...
                                                    <img src={mood[u.currentMood]} className={styles.optionMood} alt="" />
                                                </li>
                                            );
                                        })}
                                    </ul>
                                ...
                                <div
                                    ...
                                    {assignee
                                        ? <>
                                            ...
                                            <img src={mood[assignee.currentMood]} className={styles.selectMood} alt="" />
                                        </>
                                        : <>
                                            <img src={assignee_svg} className={styles.selectIcon} alt="" />
                                            <span className={styles.selectPlaceholder}>Assign to…</span>
